...
#   timestamp: 2023-04-03T10:28:08+00:00
...
from python_s2_protocol.common.schemas import ID, EnergyManagementRole, InstructionStatus, \
    PowerForecastElement, PowerValue, ReceptionStatusValues, Duration, CommodityQuantity, Currency, ControlType, Role, RevokableObjects, SessionRequestType
...
class ResourceManagerDetails(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description='Human readable name given by user')
    ...
    manufacturer: Optional[str] = Field(
        None, description='Name of Manufacturer')
