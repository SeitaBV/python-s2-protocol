...
class LeakageBehaviourElement(BaseModel):
    class Config:
        extra = Extra.forbid
...
class UsageForecastElement(BaseModel):
    class Config:
        extra = Extra.forbid
...
class FillLevelTargetProfileElement(BaseModel):
    class Config:
        extra = Extra.forbid
...
class OperationModeElement(BaseModel):
    class Config:
        extra = Extra.forbid
...
class OperationMode(BaseModel):
    ...
    elements: List[OperationModeElement] = Field(
        ...,
